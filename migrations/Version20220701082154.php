 ...
 */
final class Version20220701082154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domain ALTER id TYPE BIGINT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domain ALTER id TYPE INT');
        $this->addSql('ALTER TABLE domain ALTER id DROP DEFAULT');
    }
}
